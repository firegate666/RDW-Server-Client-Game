...
public class GalacticWar extends JApplet implements Runnable, KeyListener {
	...
	protected ImageEntity ship = new ImageEntity(this);
	...
	public void init() {
		...
		ship.load("/java5gameprogramming/spaceship1.png");
		...
		explode = new SoundClip("/java5gameprogramming/collide.wav");
		shoot = new SoundClip("/java5gameprogramming/shoot19.wav");
	...
	public void update(Graphics g) {
		...
		g2d.drawString("Move angle: " + Math.round(ship.getMoveAngle() + 90),
				5, 25);
		g2d.drawString("Kills: " + kills, 5, 40);
		g2d.drawString("Deaths: " + deaths, 5, 55);
	...
	public static void main(String[] args) {
		MainFrame frame = new MainFrame(new GalacticWar(), 1024, 768);
		frame.requestFocus();
	}
