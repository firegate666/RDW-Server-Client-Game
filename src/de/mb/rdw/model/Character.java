...
public class Character implements Serializable {
	 ...
	 */
	public static Character getFromXml(String xml) throws MarshalException,
			ValidationException {
		StringReader reader = new StringReader(xml);
		return (Character) Unmarshaller.unmarshal(Character.class, reader);
	}
